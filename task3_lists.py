...
dataset_info = (len(video_game_sales) , len(video_game_sales[0]), 'Video Game Sales' ) # the tuple is are immutable, which is appropriate for metadata that shouldn't change
