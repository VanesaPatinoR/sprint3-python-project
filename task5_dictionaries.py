...
for i in video_game_sales:
    if i[GENRE] in sales_by_genre: 
       sales_by_genre[i[GENRE]] = sales_by_genre[i[GENRE]] + i[GLOBAL_SALES]
    else:
       sales_by_genre[i[GENRE]] = i[GLOBAL_SALES]
print(sales_by_genre)

games_per_publisher = {}
for pubs in video_game_sales:
    if pubs[PUBLISHER] in games_per_publisher:
        games_per_publisher[pubs[PUBLISHER]]= games_per_publisher[pubs[PUBLISHER]] + 1
    else: 
        games_per_publisher[pubs[PUBLISHER]] = 1
