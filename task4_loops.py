...
for sales in video_game_sales:
 total_salesEU = total_salesEU + sales[EU_SALES]   
 total_salesJP = total_salesJP + sales[JP_SALES]
print(total_salesEU)
print(total_salesJP)
if total_salesEU > total_salesJP:
    print(f"The Total Sales For Norteamerica are {total_salesEU} has higher sales in the region")
elif total_salesJP > total_salesEU:
    print (f"The Total Sales For Japan are {total_salesJP} has higher sales in the region")
else:
    print(f"The Total Sales For Japan and Nort America are equal")
